...
public class InputMethods extends SelectElementByType implements BaseTest {
    ...
    public void enterTextRandomize(String accessType, String text, String pattern, String accessName) {
        String enterText;
        switch (pattern) {
            case "numeric":
                enterText = text + RandomStringUtils.randomNumeric(7);
                break;
            case "alphanumeric":
                enterText = text + RandomStringUtils.randomAlphanumeric(8);
                break;
            default:
                enterText = text + RandomStringUtils.randomAlphabetic(7);
        }

        enterText(accessType, enterText, accessName);
    }
...
//	{
//		dropdown = getDriver().findElement(getelementbytype(access_type, access_name));
//		selectList = new Select(dropdown);
//		
